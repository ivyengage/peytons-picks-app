...
export default function UploadPage() {
  ...
  return (
    <main>
      <h2>Upload CSV</h2>
      <p>CSV must use this header: <code>week,slate_type,lock_datetime_ct,game_id,game_date,kickoff_local,home_team,away_team,favorite,underdog,spread,notes</code></p>
      <input
        type="file"
        accept=".csv"
        onChange={async (e) => {
      ...
      <div style={{ marginTop: 16 }}>
        <button onClick={handleSubmit} style={{ padding: '10px 14px', background: '#CC1236', color: 'white', borderRadius: 10, border: 'none' }}>Import to Database</button>
      </div>
