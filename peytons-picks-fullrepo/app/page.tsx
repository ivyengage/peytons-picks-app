...
export default function Home() {
  return (
    <main>
      ...
      <p style={{ marginTop: 8 }}>ATS-only pick engine. Upload CSVs or (soon) screenshots → see Top-10 confidence.</p>
      <div style={{ display: 'flex', gap: 12, marginTop: 16, flexWrap: 'wrap' }}>
        ...
        <Link href="/import" style={{ padding: '10px 14px', background: '#0B2242', color: 'white', borderRadius: 10, textDecoration: 'none' }}>Import Screenshots</Link>
