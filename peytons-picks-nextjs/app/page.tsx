...
export default function Home() {
  return (
    <main>
      ...
      <p style={{ marginTop: 8 }}>ATS-only pick engine. Multi-screenshot importer. Live confidence scoring.</p>
      <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
        <Link href="/import" style={{ padding: '10px 14px', background: '#CC1236', color: 'white', borderRadius: 10, textDecoration: 'none' }}>Import Screenshots</Link>
      ...
      <div style={{ marginTop: 24, fontSize: 12, opacity: 0.7 }}>
        <p>Status: App skeleton deployed. Data connectors & importer will be enabled next.</p>
